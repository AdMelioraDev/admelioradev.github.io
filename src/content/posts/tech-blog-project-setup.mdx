...
```bash
npx create-next-app@latest admelioradev-blog
```
...
```bash
touch src/content/posts/first-post.mdx
```
...
git remote add origin https://github.com/admelioradev/admelioradev.github.io.git
